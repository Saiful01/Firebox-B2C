...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="get" action="/admin/shop/order/{{$shop_id}}" class="ng-pristine ng-valid">
                        <div class="row">
                            <div class="col-md-3">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group mr-1 mt-2">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                <a class="dropdown-item" href="/admin/shop/order-details/{{$result->order_invoice}}">Details</a>
