...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-8">
                            ...
                            <a href="/admin/order/show">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <h4 class="mb-0">{{getOrderCount()}}</h4>
                                    </div>
                            ...
                            <a href="#">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <h4 class="mb-0">{{getCustomer()}}</h4>
                                    </div>

                                    <div class="avatar-sm rounded-circle bg-primary align-self-center mini-stat-icon">
                                                        <span class="avatar-title rounded-circle bg-primary">
                                                            <i class="bx bx-user-in font-size-24"></i>
                                                        </span>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <a href="/admin/order/show">
                                <div class="media">
                                    <div class="media-body">
                                        <p class="text-muted font-weight-medium">Average Sell/Day</p>
                                        <h4 class="mb-0">0</h4>
                                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4 float-sm-left">Sell</h4>
