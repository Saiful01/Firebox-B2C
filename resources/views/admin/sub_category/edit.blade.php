        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/sub-category/update" method="post"
                         ...
                         <div class="col-sm-9">
                            <select class="form-control select2" name="category_id">
                                ...
                                @foreach($categories as $category)
                                    <option
                                    @if($category->category_id == $result->category_id) selected
                                            @endif
                        ...
                        <div class="form-group row mb-4">
                            <label for="category_address" class="col-sm-3 col-form-label">Image (200*130) <span
