@extends('layouts.app')
@section('title', 'Create Whole Sale Sub Category')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Add Whole Sale Sub Category</h4>
        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/whole-sale/sub-category/store" method="post"
