<div class="category-banner-wrapper appear-animate row mb-5 fadeIn appear-animation-visible" style="animation-duration: 1.2s;">
    <div class="col-md-6 mb-4">
        <div class="banner banner-fixed br-sm">
            <figure>
                <img src="/common/assets/images/demos/demo5/categories/2-1.jpg" alt="Category Banner" width="680" height="180" style="background-color: #EAEAEA;">
            </figure>
    ...
    <div class="col-md-6 mb-4">
        <div class="banner banner-fixed br-sm">
            <figure>
                <img src="/common/assets/images/demos/demo5/categories/2-2.jpg" alt="Category Banner" width="680" height="180" style="background-color: #565960;">
            </figure>
            <div class="banner-content y-50">
