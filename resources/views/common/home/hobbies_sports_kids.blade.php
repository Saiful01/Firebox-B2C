<div class="title-link-wrapper title-deals appear-animate mb-4">
    <h2 class="title title-link">Hobbies Sports & Kids Products</h2>
    <div class="product-countdown-container font-size-sm text-white align-items-center mr-auto">

    </div>
    <a href="/search?category=6&search=+" class="ml-0">More Products<i class="w-icon-long-arrow-right"></i></a>
</div>
...
@foreach($hobbies_products as $product)
