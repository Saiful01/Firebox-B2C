            ...
            <div class="products scrollable">
                <div class="product product-cart">
                    <div class="product-detail">
                        <a href="#" class="product-name">Solid Pattern In Fashion Summer Dress</a>
                        <div class="price-box">
                    ...
                    <figure class="product-media">
                        <a href="#">
                            <img src="/cassets/images/cart/product-1.jpg" alt="product" width="90" height="90"/>
                        </a>
                ...
                <div class="product product-cart">
                    <div class="product-detail">
                        <a href="#" class="product-name">Mackintosh Poket Backpack</a>
                        <div class="price-box">
                            <span class="product-quantity">1</span>
                    ...
                    <figure class="product-media">
                        <a href="#">
                            <img src="/cassets/images/cart/product-2.jpg" alt="product" width="90" height="90"/>
                        </a>
                        <button class="btn btn-link btn-close">
                            <i class="fas fa-times"></i>
                        </button>
