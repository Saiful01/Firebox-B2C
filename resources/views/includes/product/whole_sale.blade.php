<div class="row">
    <div class="col-sm-6">
        ...
        <div class="form-group">
            <div class="form-group">
                ...
                <select class="form-control"
                        name="sub_category_id" ng-model="sub_category_id">
        ...
        <div class="form-group">
            ...
            <input id="manufacturername" name="length" type="text" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="manufacturername"> Height</label>
            <input id="manufacturername" name="height" type="text" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <label for="price">Brand Name
                    <span class="">
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#brand">+new</button>
                    </span>
            ...
            <div class="col-md-6">
                ...
                <input id="quantity" name="materials" type="text"
                       class="form-control"
                       required>
            </div>
            <div class="col-md-6">
                ...
                <input id="quantity" name="yarn_type" type="text"
                       class="form-control"
                       required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input id="quantity" name="density" type="text"
                       class="form-control"
                       required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input id="quantity" name="design" type="text"
                       class="form-control"
                       required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input id="quantity" name="packing" type="text"
                       class="form-control"
                       required>
            </div>
            <div class="col-md-6">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-8">
                    <input id="price" name="min_quantity[]" type="number" class="form-control"
                    >
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-8">
                    <input id="price" name="max_quantity[]" type="number" class="form-control"
                    >
                </div>
            </div>
