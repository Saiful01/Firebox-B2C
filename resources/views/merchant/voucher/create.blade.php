        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/merchant/voucher/store" method="post"
                          enctype="multipart/form-data">
                        <div class="form-group row mb-4">
                            <label for="expire_date" class="col-sm-3 col-form-label">Min Spent(TK)</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="max_discount" name="min_value" required>
