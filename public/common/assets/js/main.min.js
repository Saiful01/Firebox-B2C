...
$.extend($.easing, {
    ...
    ProductSingle.prototype.init = function (e) {
        ...
        r.$wrapper = e, r.isQuickView = !!e.closest(".mfp-content").length, r._isPgVertical = !1, r.isQuickView && (n = n.bind(this), Wolmart.ratingTooltip()), l.on("initialized.owl.carousel", function (e) {
            document.body.classList.contains("home") || (r.isQuickView || l.append('<a href="#" class="product-gallery-btn product-image-full"><i class="w-icon-zoom"></i></a>'), l.parent().hasClass("product-gallery-video") && (r.isQuickView || l.append('<a href="#" class="product-gallery-btn product-degree-viewer" title="Product 360 Degree Gallery"><i class="w-icon-rotate-3d"></i></a>'), r.isQuickView || l.append('<a href="#" class="product-gallery-btn product-video-viewer" title="Product Video Thumbnail"><i class="w-icon-movie"></i></a>'))), function (e) {
    ...
    function o(e) {
        ...
        if (a.hasClass("disabled")) alert("Please select some product options before adding this product to your cart."); else {
            if (i.length) i.fadeOut(function () {
                i.fadeIn()
            }); else {
                var o = '<div class="alert alert-success alert-cart-product mb-2">                            <a href="/cart" class="btn btn-success btn-rounded">View Cart</a>                            <p class="mb-0 ls-normal">“' + a.closest(".product-single").find(".product-title").text() + '” has been added to your cart.</p>                            <a href="#" class="btn btn-link btn-close"><i class="close-icon"></i></a>                            </div>';
