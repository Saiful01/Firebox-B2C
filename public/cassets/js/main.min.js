        ...
        a.$wrapper = e, a.isQuickview = !!e.closest(".mfp-content").length, a._isPgvertical = !1, a.isQuickview && (n = n.bind(this), Riode.ratingTooltip()), s.on("initialized.owl.carousel", function (e) {
            ...
            e.$wrapper.on("click", ".btn-cart", function (t) {
                ...
                (i.closest(".product-popup").length || document.body.classList.contains("home")) && Riode.Minipopup.open({
                    ...
                    actionTemplate: '<div class="action-group d-flex mt-3"><a href="/cart" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">View Cart</a><a href="/cart" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
                })
            })
        }(this)
    ...
    init: function () {
        ...
        Riode.$body.on("click", ".cart-offcanvas .cart-toggle", function (e) {
            ...
            t.hasClass("product-single") || Riode.Minipopup.open({
                ...
                actionTemplate: '<div class="action-group d-flex"><a href="/cart" class="btn btn-sm btn-outline btn-primary btn-rounded">View Cart</a><a href="/cart" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
            })
        })
