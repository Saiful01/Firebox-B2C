    ...
    public function profile()
    {
        ...
        $result = Customer::leftjoin('customer_addresses', 'customer_addresses.customer_id', '=', 'customers.customer_id')
            ...
            ->select('customers.*', 'customer_addresses.division_id',
                'customer_addresses.district_id', 'customer_addresses.id', 'customer_addresses.upazila_id',
        ...
        return view('common.customer.index')
            ->with('orders', $orders)
            ->with('result', $result);
    }
    ...
    public function profileUpdate(Request $request)
    {
       // return $request->all();
        ...
        try {
            ...
            $exist = CustomerAddress::where('customer_id', Auth::guard('is_customer')->user()->customer_id)->first();
            if (is_null($exist)) {
            ...
            Customer::where('customer_id', $request['customer_id'])->update($customer);
